...
def resposta():
    try:
        ...
        print(report)
        print(os.path.exists('trainingXgboost.pkl')) 
        print(os.path.getsize('trainingXgboost.pkl'))
...
pipeline_class = Pipeline([
    ...
    ('clf', xgb.XGBClassifier(use_label_encoder=False, eval_metric='mlogloss'))  # Classification step using XGBoost.
])
    ...
    # Example usage:
loaded_data = load_data_classificacao('trainingXgboost.pkl')  # Loading training data from the file.
