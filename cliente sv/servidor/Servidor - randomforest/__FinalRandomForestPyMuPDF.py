...
def create_app():
    ...
    stop_words = stopwords.words('portuguese')  # Gets the list of stopwords in Portuguese.
    ...
    def preprocess_text(text):  # Defines a function for text preprocessing.
        ...
        words = [stemmer.stem(word) for word in words if word not in stop_words]  # Applies stemming and removes stopwords.
    ...
    def resposta():
        try:
            ...
            file_path = 'trainingRandomForest.pkl'
            ...
            print(report)
            print(os.path.exists('trainingRandomForest.pkl')) 
            print(os.path.getsize('trainingRandomForest.pkl'))
    ...
    def preprocess_classificacao(text_class):
        ...
        words = [stemmer.stem(word) for word in words if word not in stop_words]  # Applying stemming and removing stopwords.
    ...
    pipeline_class = Pipeline([
        ...
        ('clf', RandomForestClassifier())  # Classification step using RandomForest.
    ])
        ...
        # Example usage:
    loaded_data = load_data_classificacao('trainingRandomForest.pkl')  # Loading training data from the file.
...
if __name__ == '__main__':
    app = create_app()
    pkl = ['trainingRandomForest.pkl']
    app.run(host='SEU IP', port=5002, debug=True, extra_files=pkl)
